...
<div className='col-5'>
        ...
        <div className='col-5'>
        <label className='Teamcoachviewprofilepopuplabel-2'></label>
...
<div className='col-5'>
<label className='Teamcoachviewprofilepopuplabel'>Select Catogory</label>
...
<div className='col-5'>
<label className='Teamcoachviewprofilepopuplabel'>Coach License</label>
...
<div className='col-2'>
<img className='Teamcoachviewprofilepopupcommon-style-1' src={img10}></img>
</div>

<div className='col-5'>
<label className='Teamcoachviewprofilepopuplabel'>Country</label>
...
<div className='col-2'>
<img className='Teamcoachviewprofilepopupcommon-style-1' src={img2}></img>
</div>
