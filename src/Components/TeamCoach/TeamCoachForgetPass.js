            ...
            <div className='TeamCoachForgetPass-maindiv'>
              ...
              <div className='TeamCoachForgetPassDiv-1'>
                ...
                <div className='TeamCoachForgetPassDiv-1'>
                  ...
                  <input className="TeamCoachForgetPass-field" id='pword' type="password" placeholder="Enter a new password" name="password" value={data.password} onChange={handleChange} />
                ...
                <div className='TeamCoachForgetPassDiv-1'>
                  ...
                  <input className="TeamCoachForgetPass-field" id='rePWord' type="password" placeholder="Enter confirm password" name="confirm password" value={data.confirm_password} onChange={handleChange} />
