...
function OrganizerRestPwd() {
    ...
    const BackendData = () => {
        axiosInstance.post(`resetPasswordOrganizer/${localStorage.getItem('organizerId')}`, data)
            .then(response => {
            ...
            <div className='row'>
                ...
                <div className='AdminResetPassmaindiv-1 col-6'>
                    ...
                    <form>
                        ...
                        <input className='AdminResetPassMail' type='password' placeholder='Enter your old password' name="oldpassword"
                            value={data.email}
...
export default OrganizerRestPwd